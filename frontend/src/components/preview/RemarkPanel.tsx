      ...
      <div className="px-4 mt-2 w-full flex flex-col items-start gap-2">
        {remark && !isEditing && (
          <div className="w-full group rounded-lg p-2 hover:bg-gray-50 transition-colors flex justify-between items-start">
            ...
            <button
              ...
              className="p-1 rounded opacity-0 group-hover:opacity-100 transition-all text-[#0F2039] hover:bg-gray-200 shrink-0 ml-2"
              title="删除"
            >
        ...
        {(!remark && !isEditing) && (
          <button 
            ...
            className="p-2 rounded-full hover:bg-gray-100 transition-colors text-[#0F2039] self-center"
          >
            <svg 
